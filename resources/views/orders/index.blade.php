    ...
    <div class="card shadow-sm border-0 mx-auto" style="max-width: 760px;">
        ...
        <div class="card-body">
            ...
            <div class="mb-4">
                ...
                <ul class="list-group">
                    <li class="list-group-item d-flex justify-content-between"><span>{{ __('orders.checkout.name') }}</span><strong>{{ $viewData['user']->name }}</strong></li>
                    <li class="list-group-item d-flex justify-content-between"><span>{{ __('orders.checkout.email') }}</span><strong>{{ $viewData['user']->email }}</strong></li>
                    <li class="list-group-item d-flex justify-content-between"><span>{{ __('orders.checkout.phone') }}</span><strong>{{ $viewData['user']->phone_number ?: __('orders.checkout.not_registered') }}</strong></li>
